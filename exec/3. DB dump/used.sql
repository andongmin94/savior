...
CREATE TABLE `used` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKjhkjapdyinbw1sayxyocwucy6` (`user_seq`),
  KEY `FK3nn1i7ne47dcv90xuvpnm4mce` (`welfare_id`),
  CONSTRAINT `FK3nn1i7ne47dcv90xuvpnm4mce` FOREIGN KEY (`welfare_id`) REFERENCES `welfare` (`welfare_id`),
  CONSTRAINT `FKjhkjapdyinbw1sayxyocwucy6` FOREIGN KEY (`user_seq`) REFERENCES `user` (`user_seq`)
